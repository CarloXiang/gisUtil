	...
	$.timeCube = function(el, options) {
		...
		base.init = function() {
			...
			for (i = 0; i <= legendCount; i++) {
				...
				labelDiv.html("<div style='position: absolute;top:-23px;left: -20px'>" + label + "年</div>");
				labelDiv.css("left", Number(pixelPosition - 2) + "px"); // all other positioning is handled in CSS
