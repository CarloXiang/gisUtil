...
define([
 ...
 PopupMobile, InfoTemplate,*/ Extent, Point, jimuUtils, LoadingShelter, /*LayerInfos,
              MapUrlParamsHandler, AppStateManager,*/WebMapLoader, WebSceneLoader, Viewpoint) {
    ...
    var instance = null,
        clazz = declare(null, {
            ...
            _show2DWebMap: function (appConfig) {
                ...
                var mapDeferred = WebMapLoader.createMap(this.mapDivId, webMapPortalUrl, webMapItemId,
                    webMapOptions);
                ...
                mapDeferred.then(lang.hitch(this, function (response) {
                    ...
                    map.itemInfo = response.map.itemInfo;
                    map.webMapResponse = response;
                    // enable snapping
                    // map.enableSnapping(options);

                    html.setStyle(map.webMapResponse.root, 'zIndex', 0);
