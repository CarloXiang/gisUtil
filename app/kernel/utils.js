...
define([
    ...
    function(lang, array, html, has, config, ioQuery, query, nlt, Deferred, on, json, cookie,
             dojoNumber, dateLocale, nlsBundle, base64, esriNS, esriConfig, esriLang, /*arcgisUtils,*/
             // PopupTemplate,
             SpatialReference, Extent, Multipoint, Polyline, Polygon, webMercatorUtils, GeometryService,
             ProjectParameters, esriUrlUtils, esriRequest, /*graphicsUtils, ,*/portalUrlUtils, sharedUtils
    ) {
        /* global dojoConfig, ActiveXObject, testLoad */
        var mo = {};
